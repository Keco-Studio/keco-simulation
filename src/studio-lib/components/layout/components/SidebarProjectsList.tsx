...
import type { Project } from '@studio/lib/services/projectService';
import { truncateText } from '@studio/lib/utils/truncateText';
import projectIcon from '@studio/assets/images/projectIcon.svg';
import addProjectIcon from '@studio/assets/images/addProjectIcon.svg';
import createProjectIcon from '@studio/assets/images/createProjectIcon.svg';
import projectRightIcon from '@studio/assets/images/ProjectDescIcon.svg';
