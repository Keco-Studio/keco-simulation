...
import FolderCloseIcon from '@studio/assets/images/FolderCloseIcon.svg';
import FolderOpenIcon from '@studio/assets/images/FolderOpenIcon.svg';
import folderExpandIcon from '@studio/assets/images/folderExpandIcon.svg';
import folderCollapseIcon from '@studio/assets/images/folderCollapseIcon.svg';
import libraryBookIcon from '@studio/assets/images/LibraryBookIcon.svg';
import FolderAddLibIcon from '@studio/assets/images/FolderAddLibIcon.svg';
...
export type SidebarTreeViewProps = {
  ...
  onExpand: (expandedKeys: React.Key[], info: { node: EventDataNode<DataNode> }) => void;
  onRightClick?: (info: { event: any; node: EventDataNode<DataNode> }) => void;
};
...
export function SidebarTreeView({
  ...
  const titleRender = useCallback(
    (data: EventDataNode<DataNode> & SidebarTreeNodeMeta) => {
