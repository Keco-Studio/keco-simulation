...
import { InviteCollaboratorModal } from '@studio/components/collaboration/InviteCollaboratorModal';
import { showSuccessToast } from '@studio/lib/utils/toast';
import type { PresenceState } from '@studio/lib/types/collaboration';
import type { CollaboratorRole } from '@studio/lib/types/collaboration';
import { useLibraryData } from '@studio/lib/contexts/LibraryDataContext';
import styles from './LibraryHeader.module.css';
import libraryHeadMoreIcon from '@studio/assets/images/moreOptionsIcon.svg';
import libraryHeadVersionControlIcon from '@studio/assets/images/libraryHeadVersionControlIcon.svg';
import libraryHeadVersionClick from '@studio/assets/images/libraryHeadVersionClick.svg';
import libraryHeadExpandCollaborators from '@studio/assets/images/libraryHeadExpandCollaborators.svg';
import libraryHeadShareIcon from '@studio/assets/images/libraryHeadShareIcon.svg';
