...
import { AssetRow, PropertyConfig } from '@studio/lib/types/libraryAssets';
import { CellKey } from '@studio/components/libraries/hooks/useCellSelection';
...
import { MediaFileMetadata } from '@studio/lib/services/mediaFileUploadService';
