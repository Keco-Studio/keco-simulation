...
import versionItemRestoreIcon from '@studio/assets/images/VersionItemRestoreIcon.svg';
import versionItemAlert from '@studio/assets/images/VersionItemAlert.svg';
