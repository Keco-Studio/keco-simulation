...
import type { FieldConfig, FieldType } from '@studio/app/(dashboard)/[projectId]/[libraryId]/predefine/types';
import { FIELD_TYPE_OPTIONS, getFieldTypeIcon } from '@studio/app/(dashboard)/[projectId]/[libraryId]/predefine/utils';
import predefineLabelDelIcon from '@studio/assets/images/predefineLabelDelIcon.svg';
import predefineLabelConfigIcon from '@studio/assets/images/predefineLabelConfigIcon.svg';
import predefineDragIcon from '@studio/assets/images/predefineDragIcon.svg';
import predefineTypeSwitchIcon from '@studio/assets/images/predefineTypeSwitchIcon.svg';
