...
import { showSuccessToast, showErrorToast } from '@studio/lib/utils/toast';
import type { TabsProps } from 'antd/es/tabs';
import type { InputRef } from 'antd/es/input';
import Image from 'next/image';
import predefineLabelAddIcon from '@studio/assets/images/predefineLabelAddIcon.svg';
import predefineLabelDelIcon from '@studio/assets/images/predefineLabelDelIcon.svg';
import predefineAddSectionIcon from '@studio/assets/images/addProjectIcon.svg';
import type { SectionConfig, FieldConfig } from './types';
import type { Library } from '@studio/lib/services/libraryService';
import { getLibrary } from '@studio/lib/services/libraryService';
...
import predefineDragIcon from '@studio/assets/images/predefineDragIcon.svg';
import predefineExpandIcon from '@studio/assets/images/predefineExpandIcon.svg';
import PredefineBackIcon from '@studio/assets/images/collaborationReturnIcon.svg';
                ...
                <button
                  ...
                  onClick={() => {
                    if (hasSavedThisSessionRef.current) {
                      router.push(
                        `${KECO_SIMULATION_STUDIO_LIBRARIES_BASE}/library/${encodeURIComponent(libraryId)}?projectId=${encodeURIComponent(projectId)}`
                      );
                    } else {
                      router.back();
                    }
