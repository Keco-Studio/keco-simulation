    ...
    },
    {
      ...
      render: (_, r) => (
        <Input
          ...
          placeholder="Required: letters, digits, underscore"
        />
      ),
    },
    {
      ...
      width: 100,
      render: (_, r) => (
        <Input value={r.name} onChange={(e) => updateRow(r._idx, { name: e.target.value })} placeholder="Required" />
      ),
    },
    {
      title: 'Type',
    ...
    },
    {
      ...
      render: (_, r) => (
        <Input
          ...
          placeholder="Default by strength"
        />
      ),
    },
    {
