...
import { AppstoreOutlined, HomeOutlined, ThunderboltOutlined } from '@ant-design/icons';
import styles from './BattleBreadcrumb.module.css';

export function StudioLibrariesBreadcrumb() {
  return (
    <Breadcrumb
        ...
        },
        {
          title: (
            <span className={styles.breadcrumbCurrent}>
              <AppstoreOutlined /> Project tables (Studio)
            </span>
          ),
        },
      ]}
